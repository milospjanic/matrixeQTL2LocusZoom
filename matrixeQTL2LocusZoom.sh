...
#Create output
awk -F " " 'BEGIN{while(getline<""'"$1"'".eQTL.input.noquote.noheader.cut.sed") a[$1]=1&&b[$1]=$2 } ; a[$3] ==1 {print $4, b[$3] } ' snp142.cut_tab.chr"$2"_clean >$1.eQTL.input.noquote.noheader.cut.sed.rsid
